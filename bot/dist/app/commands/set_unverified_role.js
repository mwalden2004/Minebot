...
const command = {
    ...
    executor: async (interaction) => {
        ...
        await guild.save();
        await interaction.reply({ embeds: [(0, EmbedCreator_1.default)({ title: `Successfully updated your unverified role to ${role.name}` })] });
    }
};
exports.default = command;
//# sourceMappingURL=set_unverified_role.js.map